...
class BasicAgentAA(BustersAgent):
    ...
    #Funcion de nueva creacion, que imprime la info relevante acerca del pacman separada por comas
    def printLineData(self,gameState):
        pacmanPosition = gameState.getPacmanPosition()
        legalActions = gameState.getLegalPacmanActions()
        pacmanDirections = gameState.data.agentStates[0].getDirection()
	cadena = pacmanPosition[0] , ", " , pacmanPosition[1]
	return cadena
